<script setup lang='ts'>
  ...
  const initThree = () => {
    ...
    dom = document.querySelector('.tag1') as HTMLElement
    tag = createHtml(document.querySelector('.tag1') as HTMLElement)
  }
  // 动画循环函数
