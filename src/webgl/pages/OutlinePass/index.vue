<script setup lang='ts'>
  ...
  import { createModel,outlinePassRender } from './model'
  ...
  const initThree = () => {
    ...
    outlinePass.edgeStrength = 8 // 轮廓线强度
    outlinePass.edgeGlow = 3 // 轮廓线发光强
    outlinePass.edgeThickness = 10 // 轮廓线厚度
    outlinePass.pulsePeriod = 2// 闪烁周期
    outlinePass.visibleEdgeColor.set('#ff0000') // 轮廓线颜色
    outlinePass.hiddenEdgeColor.set('#00ff00') // 轮廓线隐藏颜色
    composerRen.addPass(outlinePass)
  }
  // 动画循环函数
