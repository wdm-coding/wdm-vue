<script setup lang='ts'>
  ...
  const initThree = () => {
    ...
    camera = cameraIns(container.value.clientWidth,container.value.clientHeight)
    camera.position.set(1600,900,1600)
    camera.lookAt(0, 0, 0)
...
<template>
  <div class='three-d-view'>
    <div style="width: 300px;height: 300px;">
      <img src="@/assets/images/webgl/1.png" style="width: 100%;height: 100%;">
    </div>
